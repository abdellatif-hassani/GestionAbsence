            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form action="modifier_etudiant.php" method="POST" autocomplete="off" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="class" id="" class="form-control">
                                    ...
                                    ?>
                                        <option value="<?=$class['idClass']?>" <?php if($etudiant["libelleClass"]==$class['idClass']) echo "selected"; ?>>
                                            <?=$class['libelleClass']?>
                                        </option>
                                    <?php } ?>
                                </select>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" name="modifier_etudiant" class="btn btn-success" > Modifier </button>
                    </div>
